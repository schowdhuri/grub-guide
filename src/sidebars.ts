  ...
  cuisineSidebar: [
    {
      ...
      items: [
        ...
        },
        {
          type: "category",
          label: "Pork Dishes",
          items: ["cuisines-view/beef-pares", "cuisines-view/lechon-kawali"],
        },
        {
          type: "category",
        ...
        },
        {
          ...
          items: ["cuisines-view/pancit-bihon", "cuisines-view/pancit-canton"],
        },
        {
          type: "category",
        ...
        },
        {
          ...
          items: ["cuisines-view/empanada", "cuisines-view/lumpia"],
        },
        {
          type: "category",
        ...
        },
        {
          type: "category",
          label: "Beverages",
          items: ["cuisines-view/buko-juice", "cuisines-view/calamansi-juice"],
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          type: "category",
          label: "Salads",
          items: ["cuisines-view/larb", "cuisines-view/som-tam"],
        },
        {
          type: "category",
          label: "Soups",
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          type: "category",
          label: "Stews & Braised",
          items: ["food/dimlama", "food/qovurma"],
        },
        {
          type: "category",
          label: "Salads",
          items: ["food/achichuk", "food/tashkent-salad"],
        },
        {
          type: "category",
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          type: "category",
          label: "Rice Dishes",
          items: ["cuisines-view/com-tam"],
        },
        {
          type: "category",
          label: "Spring Rolls & Wraps",
          items: ["cuisines-view/cha-gio", "cuisines-view/goi-cuon"],
        },
        {
          type: "category",
          label: "Bánh Mì & Sandwiches",
          items: ["cuisines-view/banh-mi"],
        },
        {
          type: "category",
          label: "Beverages",
          items: ["cuisines-view/ca-phe-sua-da"],
        },
      ],
    },
  ],
  locationSidebar: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          items: ["locations-view/balbacua"],
        },
        {
          type: "category",
          label: "Traditional Sweets (Various Regions)",
          items: ["locations-view/biko", "locations-view/suman"],
        },
        {
          type: "category",
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          items: ["locations-view/bun-bo-hue", "locations-view/mi-quang"],
        },
        {
          type: "category",
