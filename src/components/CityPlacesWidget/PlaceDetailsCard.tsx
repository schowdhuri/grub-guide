...
declare module 'react' {
  namespace JSX {
    interface IntrinsicElements {
      'gmp-place-details-compact': React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement> & { orientation?: string }, HTMLElement>;
      'gmp-place-details-place-request': React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement> & { place?: string }, HTMLElement>;
      'gmp-place-all-content': React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement>;
    }
  }
}

export default function PlaceDetailsCard({ placeId }: PlaceDetailsCardProps): React.JSX.Element {
